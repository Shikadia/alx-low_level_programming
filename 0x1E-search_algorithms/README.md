...
This project represents my work at ALX SE School focusing on search algorithms. 
I successfully implemented a range of search algorithms, providing a comprehensive
analysis of their associated space and time complexities.

## File Description

* [tests](./tests): Folder of test files for all task provided by ALX SE School.
